...
import { corpusDirFor, writeFrames } from "./corpus.js";
export async function fetchFixture(opts) {
    ...
    const scoreFrames = scores.map((u) => ({ ts: u.Ts, data: u }));
