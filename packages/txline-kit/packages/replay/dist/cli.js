...
async function main() {
    ...
    if (command === "fetch") {
        if (!fixtureId)
            throw new Error("Usage: txline-replay fetch --fixture <id> [--network devnet] [--wallet <path>] [--corpus <dir>]");
    ...
    if (command === "serve") {
        if (!fixtureId)
            throw new Error("Usage: txline-replay serve --fixture <id> [--speed 30] [--port 8788] [--corpus <dir>]");
